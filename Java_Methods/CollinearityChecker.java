...
public class CollinearityChecker {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Using Slope Method: " + arePointsCollinearUsingSlope(x1, y1, x2, y2, x3, y3));
        System.out.println("Using Area Method: " + arePointsCollinearUsingArea(x1, y1, x2, y2, x3, y3));
    }
}